...
const Hero = () => {
  return (
    <div className="relative flex flex-col xl:flex-row items-center justify-between min-h-screen p-4 xl:p-12 space-y-4 xl:space-y-0">

      {/* Text Section */}
      <div className="flex flex-col items-center xl:items-start text-center xl:text-left space-y-2 order-2 xl:order-none xl:w-1/2 px-6  sm:px-8 lg:px-12 xl:px-0 md:px-8 lg:ml-[0rem] xl:ml-[9rem]">
